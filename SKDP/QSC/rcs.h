...
/**
* \file rcs.h
* \brief <b>RCS function definitions</b> \n
...
* \remarks
* \section Description
* \paragraph The RCS (Rijndael-256 authenticated Cipher Stream) encryption functions, are a hybrid of the Rijndael-256 rounds function,
