...
* \param error: The error code
*/
SKDP_EXPORT_API void skdp_client_connection_close(skdp_client_state* ctx, const qsc_socket* sock, skdp_errors error);
...
*/
SKDP_EXPORT_API skdp_errors skdp_client_decrypt_packet(skdp_client_state* ctx, const skdp_packet* packetin, uint8_t* message, size_t* msglen);
...
* \return: The function error state
*/
SKDP_EXPORT_API skdp_errors skdp_client_encrypt_packet(skdp_client_state* ctx, const uint8_t* message, size_t msglen, skdp_packet* packetout);
...
* \return: The function error state
*/
SKDP_EXPORT_API skdp_errors skdp_client_ratchet_request(skdp_client_state* ctx, skdp_packet* packetout);
