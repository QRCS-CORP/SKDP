...
/*!
* \def SKDP_ERROR_SIZE
* \brief The size of a system message
*/
...
* \brief The keep alive integer size
*/
...
/*!
* \struct skdp_packet
* \brief The SKDP packet structure
*/
SKDP_EXPORT_API typedef struct skdp_packet
{
	uint8_t flag;							/*!< The packet flag */
	uint32_t msglen;						/*!< The packets message length */
	uint64_t sequence;						/*!< The packet sequence number */
	uint8_t* pmessage;						/*!< A pointer to the packets message data */
} skdp_packet;
...
*/
SKDP_EXPORT_API void skdp_packet_clear(skdp_packet* packet);
...
* \param error: The error type
*/
SKDP_EXPORT_API void skdp_packet_error_message(skdp_packet* packet, skdp_errors error);
...
*/
SKDP_EXPORT_API void skdp_packet_header_deserialize(const uint8_t* header, skdp_packet* packet);
...
*/
SKDP_EXPORT_API void skdp_packet_header_serialize(const skdp_packet* packet, uint8_t* header);
...
*/
SKDP_EXPORT_API size_t skdp_packet_to_stream(const skdp_packet* packet, uint8_t* pstream);
...
* \param packet: A pointer to the packet structure
*/
SKDP_EXPORT_API void skdp_stream_to_packet(const uint8_t* pstream, skdp_packet* packet);
